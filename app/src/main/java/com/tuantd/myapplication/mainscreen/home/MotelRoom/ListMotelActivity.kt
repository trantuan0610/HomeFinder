package com.tuantd.myapplication.mainscreen.home.MotelRoom
...
class ListMotelActivity : AppCompatActivity() {

    lateinit var binding : ActivityListMotelBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityListMotelBinding.inflate(layoutInflater)
